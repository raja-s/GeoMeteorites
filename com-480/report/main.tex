...
To add more information, we decided to add the (cumulative) sum beside the frequency of meteorites by year.

\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{images/timeline_final_without_label.png}
  \vspace{-3mm}
  \caption{Time line with plots of frequencies and mass total for each year.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{images/bipartite_mass}
  \vspace{-3mm}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{images/example_mouse_bipartite}
  \vspace{-3mm}
  \caption{Bipartite graph - on mouse over $stony-iron$ class}
  \label{fig:bipartite_mouse}
\end{figure}

We then noticed that the size of the country biased our first results. In order to do not give a higher weight to the biggest countries, we divided every \texttt{mass} by the area of the country where it fell, giving then the \texttt{density} of meteorites by country in $gr/km^{2}$. This time we filtered out the countries having a \texttt{density} bigger than $1$ $gr/km^{2}$ and store the remaining in $Others$.

We ended up with the following graph (Figure \ref{fig:bipartite_density}): 

\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{images/bipartite_density}
  \vspace{-3mm}
