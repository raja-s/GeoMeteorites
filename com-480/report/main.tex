...
Concerning the mass distribution, the first problem encountered was that the masses had very different values, resulting in a very skewed distribution. In order to have a smaller range and have a more normal distribution, the mass values considered were transformed in logarithmic values. 
...
We then opted for a simple histogram of values. 
...
The final statistics panel results as follow: 
