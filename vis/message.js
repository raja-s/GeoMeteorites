...
const messageMap = new Map([
    ...
    [1979,`1979, All these meteorites have the name 'Yamato'...`],
    ...
    [1985,`1985, All these meteorites have the name 'Lewis Cliff'...`],
    [1986,`1986 07 29, Kokubunji, Japan, several buildings hit by meteorites`],
    [1991,`1991 08 31, Noblesville, IN, USA, meteorite fell 3.5 m from two children outside; ordinary stony chondrite`],
    ...
    [2003,`2003 03 26, Chicago, IL, USA, meteorite shower; buildings hit in Park Forest, IL; ordinary chondrites`],
    [2004,`2004 06 12, Ellerslie, suburban Auckland, N.Z., 1.3-kg (2.8-lb) 7-cm x 13-cm meteorite broke through roof of house and bounced off sofa`],
    [2007,`2007 09 15, Carancas, Peru (near Lake Titicaca at alt. 3824 m), 13.5-m-diameter crater created by mid-day visible fireball meteorite, numerous ordinary chondrites H4-5 recovered; made international news when local people complained of illness -- not yet definitively explained`],
    [2008,`2008 10 06, Nubian desert, northern Sudan (Almahata Sitta), 47 meteorites weighing 3.95 kg were found in Dec. 2008 via a systematic search along the suspected debris path for the small minor planet 2008 TC3, discovered 20 hours prior to impact by R. A. Kowalski with the 1.5-m telescope at Mt. Lemmon in Arizona, when it was about 370000 miles from the earth; a bright fireball was seen by airline pilots and orbiting satellites when the object entered the earth's atmosphere; the largest recovered meteorite weights 1.5 g (classified as a polymict ureilite, an achondrite)`],
